      ...
      <div ref={ref} className="relative">
        ...
        <div className="space-y-8 md:pl-12">
          {items.map((item, idx) => {
            ...
            const truncated = !isExpanded && points.length > 4
              ...
              >
                ...
                <div className="glass rounded-2xl p-6 border-glow hover:glow-cyan-sm transition-all duration-300">
                  ...
                  <ul className="space-y-2">
                    {(truncated ? points.slice(0, 4) : points).map((point, i) => (
                  ...
                  {points.length > 4 && (
                    <button
                      ...
                      className="text-xs font-mono text-indigo-400 hover:text-indigo-300 mt-2 transition-colors"
                    >
                      {isExpanded ? 'Show less ↑' : `Show all ${points.length} points ↓`}
                    </button>
                  )}
                </div>
              </motion.div>
